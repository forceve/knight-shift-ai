...
\begin{table}[t]
    ...
    \hline
    \textbf{Lv.} & \textbf{Search} & \textbf{Prune} & \textbf{ID} & \textbf{Q} & \textbf{Eval / Move} \\
    \hline
    L1  & \makecell{Greedy\\(1-ply)} & No  & No & No  & \makecell[l]{Positional\\Deterministic} \\
    L2  & \makecell{Minimax\\(d=3)}  & Yes & No & No  & \makecell[l]{Material-only\\Random tie-break} \\
    L3  & Minimax & Yes & \makecell{Yes\\(to d=6)} & Yes & \makecell[l]{Rich positional\\Deterministic} \\
    Ult.& Minimax & Yes & \makecell{Yes\\(to d=8)} & Yes & \makecell[l]{PeSTO tapered\\Deterministic} \\
    \hline
    \end{tabular}
    \end{table}
