...
\paragraph{L1 vs L3.}
As shown in Figure~\ref{fig:tsb_L1_L3}, the gap between levels becomes more pronounced when the stronger engine can exploit additional computation.
If iterative deepening is used, the score curve often improves monotonically with time, reflecting deeper tactical resolution and reduced blunders.
