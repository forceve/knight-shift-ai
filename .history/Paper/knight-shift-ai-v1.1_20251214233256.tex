...
Instead of targeting specific Elo ratings, we define four discrete difficulty levels by controlling search depth, pruning aggressiveness, evaluation complexity, 
move selection randomness, and the use of Monte Carlo Tree Search with CNN-based evaluation at the highest level. 
