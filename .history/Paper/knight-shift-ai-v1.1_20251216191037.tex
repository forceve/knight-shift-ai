...
The application implements a multi-page architecture using React Router with dedicated pages: \texttt{HomePage} for overview, \texttt{PlayPage} for gameplay, \texttt{M2MPage} for machine vs. machine testing, \texttt{ReplayPage} for game analysis, and \texttt{HistoryPage} for match records. 
