...
We use a modular design with separate components for move generation, tree search, and evaluation, and use CNN-based evaluation in the Ultimate level,
and employ iterative deepening with time limits in Level 3, while the Ultimate level uses MCTS with time-based termination. 
