...
\paragraph{L1 vs L2.}
Figure~\ref{fig:tsb_L1_L2} shows how a shallow baseline compares against a low-depth search engine as time increases.
A typical pattern is that the stronger engine benefits more from extra budget, widening the score gap.
If the curve is relatively flat, it suggests that the weaker engine has limited capacity to translate extra time into stronger move quality, consistent with non-adaptive or shallow search.
