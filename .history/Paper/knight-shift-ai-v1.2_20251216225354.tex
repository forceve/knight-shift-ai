...
Figure~\ref{fig:tsb_L2_Ult} combines both search and evaluation improvements.
If the draw rate increases with time, this suggests improved defensive accuracy; if it decreases, it suggests stronger conversion ability and fewer missed wins.
