...
and iterautive deepening to provide natural time management and robustness under comptational constraints (in Level 3 and Ultimate, as well as in experimental Level 4). 
...
The AI system implements four primary difficulty levels (L1--L3 + Ultimate) for the main experiments, plus experimental variants (L4/L5) for extended testing. Each engine inherits from a common \texttt{BaseEngine} class that provides shared evaluation functions and utilities. The primary engines progressively increase in complexity:
