...
Figure~\ref{fig:tsb_L1_Ult} typically demonstrates the largest separation.
Beyond showing dominance, this curve is useful for selecting a practical default time budget: once the score saturates, extra time yields diminishing returns for this matchup.
