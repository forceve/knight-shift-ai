...
\begin{thebibliography}{00}
    ...
    ``Chess engine,'' Wikipedia. [Online]. Available: https://en.wikipedia.org/wiki/Chess_engine

    \bibitem{stockfishSkill}
    ``Stockfish skill level,'' Stockfish documentation. [Online]. Available: https://github.com/official-stockfish/Stockfish

    \bibitem{komodoSettings}
    ``Komodo chess engine,'' Komodo Chess. [Online]. Available: https://komodochess.com/
    ...
    \bibitem{playMagnus}
    ``Play Magnus,'' Chess.com. [Online]. Available: https://www.chess.com/play-magnus
