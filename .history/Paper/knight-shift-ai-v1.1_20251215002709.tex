...
In the Ultimate level's MCTS engine, this CNN provides position scores that guide Monte Carlo Tree Search under a fixed computation budget, 
while the main difficulty levels (Level 1 through Level 3) rely more heavily on theory-driven heuristic evaluation. 
