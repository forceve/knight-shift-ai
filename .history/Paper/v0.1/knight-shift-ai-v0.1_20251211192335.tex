...
However, in many circunstances, we want agents with adjustable strength that can provide meaningful practice for human players and that can operate effectively under tight time and hardware constraints.
