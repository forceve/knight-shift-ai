...
Since Claude Shannon's seminal work on Computer Playing Chess~\cite{shannon1950}, board games like chess have been seen as a kind of game-tree search problems, 
in which the agents expand and explore the move tree to solve the game and rely on heuristic evaluation functions in non-terminal nodes to approximate long-term outcomes and guide the search.
In earlier approaches of 
