...
The system implements four distinct difficulty levels by progressively introducing more search depth and evaluation complexity.
Our approach combines classical tree search algorithms, including minimax with alpha--beta pruning, iterative deepening, and quiescence search, with theory-driven and CNN-driven evaluation heuristics.
