...
\begin{abstract}
This paper presents a multi-level chess AI system designed as a course project in Artificial Intelligence Workshop. 
The AI system consists of four distinct difficulty levels, ranging from a basic minimax agent to an advanced engine with iterative deepening and sophisticated evaluation functions. 
Our approach combines classical tree search algorithms, including Minimax with Alpha--Beta pruning, iterative deepening, and quiescence search, 
with heuristic evaluation functions that incorporate material balance, piece-square tables, mobility, pawn structure, and king safety. 
The difficulty scaling is achieved through systematic variations in search depth, pruning strategies, and evaluation complexity. 
Experimental results demonstrate clear performance separation between levels, with the strongest engine achieving significantly higher win rates against lower-level opponents while maintaining reasonable computational efficiency. 
The system supports multiple game modes including human-versus-machine and machine-versus-machine matches, enabling both interactive play and systematic performance evaluation. 
This work validates the effectiveness of classical search algorithms in resource-constrained environments and provides a foundation for educational applications and future enhancements, such as integrating machine learning-based evaluation functions.
\end{abstract}
\begin{abstract}
    This paper presents a multi-level chess AI system developed as part of an Artificial Intelligence Workshop course. 
    The system implements four distinct difficulty levels, ranging from a basic minimax agent to an advanced engine with iterative deepening, quiescence search, and a more sophisticated evaluation function. 
    Our approach combines classical game-tree search algorithms, including minimax with alpha--beta pruning, iterative deepening, and quiescence search, with handcrafted heuristic evaluation functions that incorporate material balance, piece-square tables, mobility, pawn structure, and king safety. 
    Difficulty scaling is achieved through systematic variations in search depth, pruning settings, and evaluation complexity, as well as controlled stochasticity in move selection at lower levels. 
