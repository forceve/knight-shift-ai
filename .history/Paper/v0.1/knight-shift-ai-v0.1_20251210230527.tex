...
The system implements four distinct difficulty levels, ranging from a basic minimax agent to an advanced engine with iterative deepening and sophisticated evaluation functions. 
