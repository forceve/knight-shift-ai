...
\begin{itemize}
    \item We design and implement a multi-level chess AI system that exposes four difficulty tiers by varying search depth, pruning aggressiveness, evaluator choice, and controlled randomness in move selection, and supports human-versus-machine, machine-versus-machine, limited-time, and batch-testing modes for training and benchmarking.
