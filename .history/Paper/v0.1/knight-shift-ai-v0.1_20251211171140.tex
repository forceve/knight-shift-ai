...
Chess was among the first board games in which agents rivaled and eventually surpassed top human players, making it a classic subject for research in artificial intelligence for decades.
Early work such as Shannon's 1950 paper ``Programming a Computer for Playing Chess'' [1] emphasized that the goal of computer chess research is not merely to solve the game itself, but to develop search and evaluation techniques that can be applied more broadly to general ``thinking machines''. 
