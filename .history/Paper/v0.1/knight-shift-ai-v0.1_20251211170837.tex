...
Early work such as Shannon's 1950 paper ``Programming a Computer for Playing Chess'' emphasized that the goal of computer chess research is not merely to solve the game itself, but to develop search and evaluation techniques that can be applied more broadly to general ``thinking machines''. 
Building on this tradition, modern chess engines combine powerful search algorithms with sophisticated evaluation functions, and continue to provide a rich testbed for studying decision-making under resource constraints.
...
\bibitem{shannon1950}
[1] C. E. Shannon, “Programming a computer for playing chess,”
