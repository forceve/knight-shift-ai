...
In our system, we adopt the classical minimax framework with alpha--beta pruning and iterative deepening, rather than MCTS or best-first algorithms such as SSS* or B*. 
This choice prioritizes conceptual clarity, ease of implementation, and fine-grained control over search depth and pruning behavior, 
which are crucial for exposing interpretable difficulty levels. 
The techniques reviewed above directly inform our design of search depth limits, pruning configurations, and move-ordering strategies across different levels in our multi-level chess AI.
