...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.48\textwidth]{pairing_avg_score.png}
\caption{M2M Round-Robin Results (Avg. Score)}
\label{fig:pairing_avg_score}
\end{figure}

\noindent Figure~\ref{fig:pairing_avg_score} reports the overall score percentage
