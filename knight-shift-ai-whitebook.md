...
**Language**: The project uses **English**. / 所有内容，包括注释，全部使用 **英文**。开发文档除外，使用中英混合。
...
- **History page** (`/history`)
  ...
  - Aggregated list of recent H2H/H2M and M2M games with winner/result/move count.
  - Helpful for quickly locating games to replay or summarize.
...
- **Draw avoidance**: penalize move choices that lead to immediate threefold repetition to reduce quick draws.
...
- Visual indicators:
  ...
  - Last move highlight
- Endgame UX: modal summary on finish (winner/reason/move count) with quick restart.
- Replay UX: playback controls with optional autoplay/speed control.
